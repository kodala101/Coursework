...
//}
//
//bool isLazy(node*& base) {
//	for (int i = 0; i < 5; i++) {
//		if (base->lazyProp[i] != 'a' + i) return true;
//	}
//	return false;
//}
//
...
//	if (isLazy(base->left)) {
//		for (int i = 0; i < 5; i++) {
//			if (base->lazyProp[i] != 'a' + i) {
//				for (int j = 0; j < 5; j++) {
//					if (base->left->lazyProp[j] == 'a' + i) {
//						base->left->lazyProp[j] = base->lazyProp[i];
//					}
//				}
//			}
//		}
//	}
//	int save[5];
//	for (int i = 0; i < 5; i++) save[i] = base->left->coloredNodesInInterval[i];
//	for (int i = 0; i < 5; i++) {
//		base->left->coloredNodesInInterval[i] = 0; //!
//		base->left->lazyProp[i] = base->lazyProp[i];
//	}
//	for (int i = 0; i < 5; i++) {
//		base->left->coloredNodesInInterval[base->left->lazyProp[i] - 'a'] += save[i];
//	}
//
//
//	if (isLazy(base->right)) {
//		for (int i = 0; i < 5; i++) {
//			if (base->lazyProp[i] != 'a' + i) {
//				for (int j = 0; j < 5; j++) {
//					if (base->right->lazyProp[j] == 'a' + i) {
//						base->right->lazyProp[j] = base->lazyProp[i];
//					}
//				}
//			}
//		}
//	}
//	int savee[5];
//	for (int i = 0; i < 5; i++) savee[i] = base->right->coloredNodesInInterval[i];
//	for (int i = 0; i < 5; i++) {
//		base->right->coloredNodesInInterval[i] = 0; //!
//		base->right->lazyProp[i] = base->lazyProp[i];
//	}
//	for (int i = 0; i < 5; i++) {
//		base->right->coloredNodesInInterval[base->right->lazyProp[i] - 'a'] += savee[i];
//	}
//
//
//	for (int i = 0; i < 5; i++) {
...
//	if (base == NULL) return;
//	if (isLazy(base)) propagation(base);
